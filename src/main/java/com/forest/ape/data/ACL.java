...
public class ACL implements Record {
	private int perms;
	private com.forest.ape.data.Id id;

	public ACL() {
	}

	public ACL(int perms, com.forest.ape.data.Id id) {
		this.perms = perms;
		this.id = id;
	}
	...
	public com.forest.ape.data.Id getId() {
		return id;
	}

	public void setId(com.forest.ape.data.Id m_) {
		id = m_;
	}
