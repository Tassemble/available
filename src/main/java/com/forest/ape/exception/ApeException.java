...
package com.forest.ape.exception;
...
import com.forest.ape.OpResult;

@SuppressWarnings("serial")
public abstract class ApeException extends Exception {
    /**
     ...
     *  the caller.
     */
    public static ApeException create(Code code, String path) {
        ApeException r = create(code);
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static ApeException create(int code, String path) {
        ApeException r = create(Code.get(code));
        r.path = path;
        return r;
    }
     ...
     */
    @Deprecated
    public static ApeException create(int code) {
     ...
     * the caller.
     */
    public static ApeException create(Code code) {
        switch (code) {
            case SYSTEMERROR:
    ...
    public ApeException(Code code) {
        this.code = code;
    }

    ApeException(Code code, String path) {
        this.code = code;
        this.path = path;
    }
     ...
     *  @see Code#APIERROR
     */
    public static class APIErrorException extends ApeException {
     ...
     *  @see Code#AUTHFAILED
     */
    public static class AuthFailedException extends ApeException {
     ...
     */
    public static class BadArgumentsException extends ApeException {
     ...
     * @see Code#BADVERSION
     */
    public static class BadVersionException extends ApeException {
     ...
     */
    public static class ConnectionLossException extends ApeException {
     ...
     */
    public static class DataInconsistencyException extends ApeException {
     ...
     * @see Code#INVALIDACL
     */
    public static class InvalidACLException extends ApeException {
     ...
     */
    public static class InvalidCallbackException extends ApeException {
     ...
     */
    public static class MarshallingErrorException extends ApeException {
     ...
     * @see Code#NOAUTH
     */
    public static class NoAuthException extends ApeException {
     ...
     */
    public static class NoChildrenForEphemeralsException extends ApeException {
     ...
     * @see Code#NODEEXISTS
     */
    public static class NodeExistsException extends ApeException {
     ...
     * @see Code#NONODE
     */
    public static class NoNodeException extends ApeException {
     ...
     * @see Code#NOTEMPTY
     */
    public static class NotEmptyException extends ApeException {
     ...
     */
    public static class OperationTimeoutException extends ApeException {
     ...
     */
    public static class RuntimeInconsistencyException extends ApeException {
     ...
     */
    public static class SessionExpiredException extends ApeException {
     ...
     */
    public static class SessionMovedException extends ApeException {
     ...
     */
    public static class NotReadOnlyException extends ApeException {
     ...
     */
    public static class SystemErrorException extends ApeException {
     ...
     */
    public static class UnimplementedException extends ApeException {
