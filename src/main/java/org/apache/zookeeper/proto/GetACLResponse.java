...
public class GetACLResponse implements Record {
  private java.util.List<com.forest.ape.data.ACL> acl;
  private com.forest.ape.data.Stat stat;
  public GetACLResponse() {
  }
  public GetACLResponse(
        java.util.List<com.forest.ape.data.ACL> acl,
        com.forest.ape.data.Stat stat) {
    this.acl=acl;
    this.stat=stat;
  }
  public java.util.List<com.forest.ape.data.ACL> getAcl() {
    return acl;
  }
  public void setAcl(java.util.List<com.forest.ape.data.ACL> m_) {
    acl=m_;
  }
  public com.forest.ape.data.Stat getStat() {
    return stat;
  }
  public void setStat(com.forest.ape.data.Stat m_) {
    stat=m_;
  }
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    a_.startRecord(tag);
    {
      ...
      if (vidx1!= null) {          acl=new java.util.ArrayList<com.forest.ape.data.ACL>();
    ...
    stat= new com.forest.ape.data.Stat();
